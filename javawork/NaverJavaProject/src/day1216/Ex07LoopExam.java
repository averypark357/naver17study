...
public class Ex07LoopExam {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		/*
		 * 1. 지수승구하기 2. 팩토리알 구하기 3. 원의 넓이 구하기 4. 종료
		 * while 반복문에서 위의 메뉴가 나오면 번호를 입력하고 해당 데이타를 입력 후
		 * 결과값을 출력하시오
		 * switch 문
		 * 1번 : 두 수 x, y를 입력 후 x의 y승(for문)을 구하여 출력하시오
		 * 2번 : 숫자 n 을 입력 후 n!값을 구하시오(for문)          팩토리얼 3이면 1부터 3까지 곱한거
		 * 3번 : 반지름 r을 입력하면 원의 넓이를 구해서 출력(반지름*반지름*Math.PI)        Math.PI-> 3.141592
